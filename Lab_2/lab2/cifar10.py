...
def load_batch(filepath: str) -> (np.ndarray, np.ndarray):
    ...
    with open(filepath, 'rb') as f:
        ...
        # ! we need to transform the vector into shape (.., 3, 32, 32) because the pixels are
        # ! categorized after the color not the pixel (where you have 3 colors at for a pixel,
        # ! not a color for every pixel
        ...
        # * 10000 because is the size of the batch
